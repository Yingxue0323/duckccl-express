...
export enum ResponseCode {
  ...
  GET_EXERCISE_BY_ID_FAILED = 43004,
  UPDATE_EXERCISE_FAILED = 43005,
  DELETE_EXERCISE_FAILED = 43006,

  // 练习学习状态相关 (43007-43012)
  LEARN_EXERCISE_FAILED = 43007,
  UNLEARN_EXERCISE_FAILED = 43008,
  GET_EXE_LEARNING_STATUS_FAILED = 43009,
