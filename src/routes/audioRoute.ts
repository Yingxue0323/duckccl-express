...
// TODO: admin only
router.post('/', authMiddleware, audioController.createAudio); // 创建音频, admin only
router.patch('/:id', authMiddleware, audioController.updateAudio); // 更新音频, admin only
router.delete('/:id', authMiddleware, audioController.deleteAudio); // 删除音频, admin only
